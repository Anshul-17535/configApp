...
import AddEditDialog from '../../containers/destinationtracing/addEditDialog';
...
import {getToolBarData,addKeyStore,addTrustStore,setDialogType,setDialogState,addMirrorServer,addNewHttpServer,addNewHep3Server,addNewKafkaCluster,addNewRemoteFile} from '../../actions/destinationprofile';
...
class ToolBar extends Component {
    ...
    activateModal = () => {
        this.props.addKeyStore();
        this.props.addNewHttpServer();
        this.props.addNewHep3Server();
        this.props.addNewKafkaCluster();
        this.props.addNewRemoteFile();
        this.props.addTrustStore();
        this.props.addMirrorServer();
...
function mapStateToProps(state) {
    return{
        toolBar: state.dstptoolbar,
        newEditDialog: state.dstpnewEditDialog,
    }
}
