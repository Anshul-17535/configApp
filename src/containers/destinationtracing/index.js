...
import {setSuccessFlag} from "../../actions/destinationprofile/commonservices";
let srv;
...
function mapStateToProps(state) {
    return{
        successFlag: state.dstptoolbar.successFlag,
        successMessage: state.dstptoolbar.successMessage
    }
}
