...
import {setFilterCriteriaContext,setFilterCriteriaName,setFilterCriteriaOperator,setFilterCriteriaValuesArray,updateparamNameAndValsForCriteria,updateErrorState} from '../../actions/messagefilter'
import {setContextData} from '../../actions/messagefilter/commonServices'
import '../../styles/messageFilter/CriteriaInputGroup.css'
...
function mapStateToProps(state) {
    return{
        ContextAttributesList:state.mfnewEditDialog.listcontextsforattrs,
