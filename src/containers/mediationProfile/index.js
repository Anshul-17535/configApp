...
import {setSuccessFlag} from "../../actions/mediationProfile/commonservices";
let srv;
...
function mapStateToProps(state) {
    return{
        successFlag: state.mpctoolbar.successFlag,
        successMessage: state.mpctoolbar.successMessage
    }
}
