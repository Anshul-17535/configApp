...
import {setSuccessFlag} from "../../actions/slfnfprofile/commonservices";
let srv;
...
function mapStateToProps(state) {
    return{
        successFlag: state.slfNfProfiletoolbar.successFlag,
        successMessage: state.slfNfProfiletoolbar.successMessage
    }
}
