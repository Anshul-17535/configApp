...
import {setSuccessFlag} from "../../actions/slfdestinationmap/commonservices";
let srv;
...
function mapStateToProps(state) {
    return{
        successFlag: state.slfDestinationMaptoolbar.successFlag,
        successMessage: state.slfDestinationMaptoolbar.successMessage
    }
}
