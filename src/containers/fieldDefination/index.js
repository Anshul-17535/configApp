...
import {setSuccessFlag} from "../../actions/fieldDefination/commonservices";
let srv;
...
function mapStateToProps(state) {
    return{
        successFlag: state.fdctoolbar.successFlag,
        successMessage: state.fdctoolbar.successMessage
    }
}
