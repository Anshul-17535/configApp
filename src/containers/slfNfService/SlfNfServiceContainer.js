...
import {setDialogState} from '../../actions/slfnfservice';
...
class SlfNfServiceContainer extends Component{
    ...
    componentWillMount(){
        const {currentNfServiceConfig}=this.props
        
        if(!_.isEmpty(currentNfServiceConfig)){
            let currentNfServiceConfigCopy={...currentNfServiceConfig}
...
function mapStateToProps(state) {
    return{
        currentNfServiceConfig:state.slfNfServicenewEditDialog.currentNfServiceConfig
    }
}
