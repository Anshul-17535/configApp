...
import AddEditDialog from '../../containers/peerConfig/addEditDialog';
import {getSplitScreenData,toggleSplitScreen} from '../../actions/splitScreenOptions';
import {getAllData,getEgressProfileByType,getIngressProfileByType} from '../../actions/peerconfig/commonservices';
import {getToolBarData,setDialogType,setDialogState,addNewPeerIPData,addNewPeerEPData} from '../../actions/peerconfig';
...
class ToolBar extends Component {
    ...
    activateModal = () => {
        this.props.addNewPeerIPData();
        this.props.addNewPeerEPData();
    ...
    componentWillMount() {
        ...
        this.props.getIngressProfileByType();
        this.props.getEgressProfileByType();
    }
...
function mapStateToProps(state) {
    return{
        toolBar: state.peertoolbar,
        newEditDialog: state.peernewEditDialog,
        toggleState: state.peerdataGrid.toggleState,
    }
}
...
function matchDispatchToProps(dispatch){
    return bindActionCreators({
        ...
        addNewPeerEPData,
        getAllData,
        getEgressProfileByType,
        getIngressProfileByType,
        onSideClick
    }, dispatch);
}
