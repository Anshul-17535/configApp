...
import {setSuccessFlag} from "../../actions/slfconfiguration/commonservices";
let srv;
...
function mapStateToProps(state) {
    return{
        successFlag: state.slfConfigtoolbar.successFlag,
        successMessage: state.slfConfigtoolbar.successMessage
    }
}
