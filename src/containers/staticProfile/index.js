...
import {setSuccessFlag} from "../../actions/staticProfile/commonservices";
import {setExportErrorDialog} from "../../actions/staticProfile/"
let srv;
class Index extends Component {
    ...
    componentDidMount(){
        srv.props.setExportErrorDialog(false)
        srv.props.setSuccessFlag(false);
    }
...
function mapStateToProps(state) {
    return{
        successFlag: state.statproftoolbar.successFlag,
        successMessage: state.statproftoolbar.successMessage
    }
}
