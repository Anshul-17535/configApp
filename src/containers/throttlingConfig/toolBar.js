...
import AddEditDialog from '../../containers/throttlingConfig/addEditDialog';
import {getSplitScreenData,toggleSplitScreen} from '../../actions/splitScreenOptions';
import {getAllData,getInboundProfileByType} from '../../actions/throttlingconfig/commonservices';
import {getToolBarData ,setDialogType,setDialogState,addNewThrottlingData} from '../../actions/throttlingconfig';
...
class ToolBar extends Component {
    ...
    componentWillMount() {
        ...
        this.props.getInboundProfileByType();
    }
...
function mapStateToProps(state) {
    return{
        toolBar: state.thctoolbar,
        newEditDialog: state.thcnewEditDialog,
        toggleState:state.thcdataGrid.toggleState,
    }
}
