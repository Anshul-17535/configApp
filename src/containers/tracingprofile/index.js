...
import {setSuccessFlag} from "../../actions/tracingprofile/commonservices";
let srv;
...
function mapStateToProps(state) {
    return{
        successFlag: state.tcptoolbar.successFlag,
        successMessage: state.tcptoolbar.successMessage
    }
}
