...
const url = `${globals.protocol}://${globals.host}/${globals.service}/${globals.mediationurl}`;
...
export function createMpcConfig(thrConfig){
...
export function updateMpcConfig(thrConfig){
...
export function deleteMPCConfig(dstcConfig){
